...
class App extends React.Component {
    ...
    componentDidMount() {
        ...
        this.state.socket.on("user_join_response", () => this.log("Server", "Welcome to the Brainy Orthographic Grid Game: Learning Edition! Please ensure you set your username."));
